    ...
    return (
        <section ref={sectionRef} className="humble-beginnings-section">
            ...
            <div className="container">
                <span className="badge-about">Our Blog</span>

                <h1 className="main-heading">
                    Insights, tips, and inspiration for <span className="brand-red">Custom Patches</span>
                </h1>

                <p className="sub-heading">
                    Explore our latest articles, design guides, and industry trends to help you create the ultimate embroidered, PVC, or leather patches for your brand.
                </p>
                ...
                <div className="stats-grid">
                    ...
                    <div className="stat-card stat-card-red">
                        <span className="stat-number red-text">Tips</span>
                        <span className="stat-label">& Tricks</span>
                    </div>

                    <div className="stat-card">
                        <span className="stat-number">Inspiration</span>
