...
const EmbroideredFAQAccordion = () => {
   ...
   const faqs = [
    {
        question: 'What Are Custom Chenille Patches?',
        answer: 'Chenille patches are textured patches made with soft, raised yarn that creates a bold and distinctive three-dimensional appearance.'
    },
    {
        question: 'What Are Chenille Patches Best Used For?',
        answer: 'Custom chenille patches are especially popular for varsity jackets, sports teams, schools, colleges, clubs, and fashion apparel.'
    },
    {
        question: 'Can I Create Custom Chenille Letter Patches?',
        answer: 'Yes. We can create personalized chenille letters, numbers, names, logos, mascots, and other designs.'
    },
    {
        question: 'Can Chenille Patches Be Used on Varsity Jackets?',
        answer: 'Yes. Custom chenille varsity patches are a popular choice for jackets and team apparel because of their raised and textured appearance.'
    },
    {
        question: 'Can I Customize Chenille Patch Colors?',
        answer: 'Yes. You can select colors and design elements to match your team, school, club, brand, or personal style.'
    },
    {
        question: 'What Backing Options Are Available for Chenille Patches?',
        answer: 'Backing options can include sew-on and other suitable attachment methods depending on the garment or product where the patch will be applied.'
    },
    {
        question: 'What is the minimum order quantity (MOQ) for chenille patches?',
    ...
    },
    {
        ...
        answer: 'We accept high-resolution vector files such as AI, EPS, PDF, as well as standard image formats like PNG and JPEG. Our team will optimize your file for high-density yarn weaving.'
    },
    {
