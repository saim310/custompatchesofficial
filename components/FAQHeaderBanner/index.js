    ...
    return (
        <section ref={sectionRef} className="humble-beginnings-section">
            ...
            <div className="container">
                <span className="badge-about">Help & Support</span>

                <h1 className="main-heading">
                    Everything you need to know about ordering <span className="brand-red">Custom Patches</span>
                </h1>

                <p className="sub-heading">
                    Got questions about artwork files, turnaround times, backings, or bulk discounts? Find all your answers right here or reach out to our team.
                </p>
                ...
                <div className="stats-grid">
                    ...
                    <div className="stat-card">
                        ...
                        <span className="stat-label">Free Proofs</span>
                    </div>

                    <div className="stat-card stat-card-red">
                        <span className="stat-number red-text">0$</span>
