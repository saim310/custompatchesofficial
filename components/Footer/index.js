    ...
    return(
        <div className={`wpo-footer-area ${props.Ftclass}`}>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-4 col-md-12 col-sm-12 col-12">
                            <div className="wpo-footer-social">
                                <ul>
                                    <li><Link legacyBehavior href="/"><a><i className="fa fa-facebook"></i></a></Link></li>
                                    <li><Link legacyBehavior href="/"><a><i className="fa fa-twitter" aria-hidden="true"></i></a></Link></li>
                                    <li><Link legacyBehavior href="/"><a><i className="fa fa-instagram" aria-hidden="true"></i></a></Link></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div className={`wpo-footer-bottom ${props.Fbclass}`}>
                <span>© 2021 <Link legacyBehavior href="/">Follio</Link>. All rights reserved</span>
            </div>
        </div>
    )
}
