	...
	<div className="header-style-1">
        <div className="container">
            <div className="header-content">
                <div className="logo">
                    <Link legacyBehavior href="/" title=""><a><img src='images/logo.png' alt=""/></a></Link>
                </div>
                <nav className="d-lg-block d-none header-b">
                    <ul>
                        ...
                        <li><Link legacyBehavior  href="/PorfolioGrid">Portfolio</Link>
                            <ul>
                ...
                <div className="cart-search-contact">
                        <Link legacyBehavior href="/ContactPage"><a className="theme-btn">Lets Talk</a></Link>
                    </div>
                </div>
